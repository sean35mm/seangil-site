...
const ChildAppetiteBanner = () => {
	return (
		<Link href={'/childappetite'}>
			<div className='sm:w-3/12 xl:w-1/5 m-2 cursor-pointer border-black border bg-gradient-to-b from-cyan-400 to-blue-500 rounded-lg flex hover:shadow-black hover:shadow-2xl'>
