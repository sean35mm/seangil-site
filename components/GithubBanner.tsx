...
const GithubBanner = () => {
	return (
		<Link href={'https://github.com/sean35mm'}>
			<div className='md:w-1/3 md:h-auto h-28 m-2 cursor-pointer border-black border bg-gradient-to-b from-slate-400 to-slate-800 rounded-lg flex hover:shadow-black hover:shadow-2xl'>
